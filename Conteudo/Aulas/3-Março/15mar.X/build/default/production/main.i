...
int opcao = 0;
void __attribute__((picinterrupt(("high_priority")))) funcInt(void){
...
void main(void) {
    ...
    while(1){
        switch(opcao){
            ...
            case 1: PORTD+=1;_delay((unsigned long)((500)*(4000000/4000.0)));break;
            case 2: PORTD-=1;_delay((unsigned long)((500)*(4000000/4000.0)));
        }
    }
      return;
}
